namespace DelegateDecompiler
{
	...
	internal class Address
	{
		...
		public static implicit operator Expression(Address address) => address?.Expression;

		public static implicit operator Address(Expression expression) => new Address { Expression = expression };
